...
export function WalletScreen({ navigation }: Props) {
  ...
  return (
    <ScreenContainer scroll>
      <View className="mt-4">
        <Text className="text-ink-900 text-2xl font-bold">{t('wallet.title')}</Text>
        <Text className="text-muted text-sm mt-1">{t('wallet.subtitle')}</Text>
      </View>

      <View className="mt-6">
        <Card>
          <Text className="text-muted text-sm">{t('wallet.availableBalance')}</Text>
          ...
          <View className="flex-row justify-between">
            <View>
              <Text className="text-muted text-xs">{t('wallet.thisMonth')}</Text>
              <Text className="text-ink-900 font-bold mt-0.5">{formatCurrency(124.5)}</Text>
            </View>
            <View>
              <Text className="text-muted text-xs">{t('wallet.trips')}</Text>
              <Text className="text-ink-900 font-bold mt-0.5">18</Text>
            </View>
            <View>
              <Text className="text-muted text-xs">{t('wallet.bonus')}</Text>
