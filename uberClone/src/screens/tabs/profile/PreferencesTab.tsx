...
export function PreferencesTab() {
  ...
  return (
    ...
    >
      <Card>
        <Text className="text-ink-900 font-bold mb-4">{t('preferences.language')}</Text>
        <Select<Language>
          value={language}
      ...
      <View className="mt-4">
        <Card>
          <Text className="text-ink-900 font-bold mb-2">{t('preferences.notifications')}</Text>
          <View className="flex-row items-center justify-between py-3">
            <View className="flex-row items-center flex-1">
              <Bell size={18} color="#6B7280" />
              <Text className="text-ink-900 font-semibold ml-3">
      ...
      <View className="mt-4">
        <Card>
          <Text className="text-ink-900 font-bold mb-2">{t('preferences.appearance')}</Text>
          <View className="flex-row items-center justify-between py-3">
            <View className="flex-row items-center flex-1">
