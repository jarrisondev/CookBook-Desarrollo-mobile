        ...
        <View className="bg-surface rounded-t-3xl px-5 pt-5 pb-8" style={shadows.cardLg}>
          ...
          <View className="flex-row items-center">
            ...
            <View className="flex-1 ml-4">
              <Text className="text-ink-900 font-bold text-lg">{mockDriver.name}</Text>
              <View className="flex-row items-center mt-0.5">
                <Star size={14} color="#F59E0B" fill="#F59E0B" />
                <Text className="text-ink-700 text-sm ml-1">{mockDriver.rating.toFixed(1)}</Text>
                <Text className="text-muted text-sm"> · {mockDriver.car}</Text>
              </View>
              <Text className="text-muted text-xs mt-0.5">Plate {mockDriver.plate}</Text>
            </View>
          </View>
